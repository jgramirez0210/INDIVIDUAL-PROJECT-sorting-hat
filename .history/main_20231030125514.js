...
const createCard = (e) => {
  ...
  const lastName = document.querySelector('.form-control[type="text"]').value;
    const newStudent = {
...
const intakeForm = () => {
  ...
  <input class="form-control" id="first type="text" placeholder="Students First Name" aria-label="default input example">

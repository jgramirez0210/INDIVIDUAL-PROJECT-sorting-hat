...
const filterButtons = () => {
  const domString = ` <button class="btn btn-secondary btn-lg buttonRow" id="gryffindor">Gryffindor</button>
  <button class="btn btn-secondary btn-lg buttonRow" id="Hufflepuff">Javascript</button>

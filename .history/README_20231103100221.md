...
Name of Project: 
  Sorting Hat
Overview of Project: 
  The Sorting Hat is a web app that allows users to create students then have them randomly assigned to one of the four houses at Hogwarts (Gryffindor, Hufflepuff, Ravenclaw, Slytherin), you can even expel them to "Lord Voldy Mold 

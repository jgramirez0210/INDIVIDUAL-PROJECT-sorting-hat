...
const filterButtons = () => {
  const domString = `  // Corrected variable name case
    ...
    <button class="btn btn-secondary btn-lg buttonRow" value="gryffindor" id="hufflepuff">Hufflepuff</button>
    <button class="btn btn-secondary btn-lg buttonRow" value="gryffindor" id="ravenclaw">Ravenclaw</button>
    <button class="btn btn-secondary btn-lg buttonRow" value="gryffindor" id="slytherin">Slytherin</button>
  `;

...
const filterButtons = () => {
  const domString = `
    ...
    <button class="btn btn-secondary btn-lg buttonRow" id="showHouses">Show All Houses</button>
    <button class="btn btn-secondary btn-lg buttonRow" id="showAll">Slytherin</button>
